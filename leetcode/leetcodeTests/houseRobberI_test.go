...
func ExampleHouseRobI() {
	...
	fmt.Println(leetcode.Rob1([]int{1}))
	fmt.Println(leetcode.Rob1([]int{4,1,2}))
	// output:
	// 4173
	// 1
	// 6
...
func ExampleHouseRobII() {
	fmt.Println(leetcode.Rob2([]int{1}))
	fmt.Println(leetcode.Rob2([]int{4,1,2}))
	// output:
	// 1
	// 4
}
